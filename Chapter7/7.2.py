"""
Доработайте игру "Викторина" таким образом, чтобы она хранила в
файле список рекордов. В список должны попадать имя и результат
игрока-рекордсмена. Используйте для хранения таблицы рекордов
консервированный объект.
"""
...
def read_achievements(file_name):
    ...
    try:
        ...
        achievements = []
        achievement = pickle.load(file, encoding="utf-8")
...
def work_achievements(gamer, score):
    ...
    achievements = read_achievements("7.achievements.dat")
    if not achievements:
        achievements = []
    ...
    write_achievements("7.achievements.dat", achievements)
